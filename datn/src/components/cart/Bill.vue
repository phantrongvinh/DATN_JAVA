    ...
    <ul class="list-group">
      ...
      >
        <div class="d-flex align-items-center">
          ...
          >
            <i class="material-symbols-rounded text-lg">priority_high</i>
          </button>
          <div class="d-flex flex-column">
    ...
    <div class="card-header pb-0 px-3">
      <div class="row">
        ...
        >
          ...
          <small>{{ ulti.formatDate(new Date(Date.now())) }}</small>
        </div>
      </div>
    </div>
    <div class="card-body">
      ...
      <div class="d-flex justify-content-between">
        <h5>Thành tiền</h5>
        <h5 class="text-danger">4.980.000đ</h5>
      </div>
      ...
      <button class="btn bg-gradient-danger w-100 mt-4">Thanh toán</button>
    </div>
  </div>
</template>
