...
public class ReturnRequestService implements IReturnRequestService {
    ...
    @Transactional
    @Override
    public void requestReturn(Integer userId, Integer orderId, String reason, List<String> imageUrls) {
    ...
    public void resolveReturn(Integer returnRequestId, boolean approved, String adminNote) {
        ...
        rr.setStatus(approved ? ReturnStatus.APPROVED : ReturnStatus.REJECTED);
